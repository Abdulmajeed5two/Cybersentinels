  ...
  return (
    <section className="py-12 bg-linear-65 from-black to-purple-500">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-5 py-16 md:px-10 md:py-20">
        ...
        <p className="font-inter mx-auto mb-12 mt-4 max-w-lg px-5 text-center text-white text-base font-light">
          AI continuously scans and detects suspicious activity in real time. Instantly receive alerts and take action with one-click security solutions.
        </p>
        <div className="flex flex-col items-start justify-center md:flex-row">
          <div className="relative my-8 flex w-full rounded-md md:mx-8 md:flex-col">
            ...
            <div className="ml-6 md:ml-0">
              <h2 className="mb-5 text-xl font-medium md:mt-8 text-white">
                AI Scans in Real-Time
              </h2>
              <p className="font-inter max-w-md pr-5 text-base text-white">
                Our AI continuously monitors your system, detecting suspicious activity the moment it happens.
              </p>
            </div>
		        ...
		        <svg className="absolute -bottom-12 left-7 md:hidden" width="12" height="70" viewBox="0 0 12 95" fill="none" xmlns="http://www.w3.org/2000/svg">
		          <path d="M6 0.226497L0.226497 6L6 11.7735L11.7735 6L6 0.226497ZM6 94.7735L11.7735 89L6 83.2265L0.226497 89L6 94.7735ZM5 6V10.15H7V6H5ZM5 18.45V26.75H7L7 18.45H5ZM5 35.05L5 43.35H7V35.05H5ZM5 51.65L5 59.95H7L7 51.65H5ZM5 68.25L5 76.55H7L7 68.25H5ZM5 84.85L5 89H7V84.85H5Z" fill="white"></path>
		        </svg>
          ...
          <div className="relative my-8 flex w-full rounded-md md:mx-8 md:flex-col">
            ...
            <div className="ml-6 md:ml-0">
              <h2 className="mb-5 text-xl font-medium md:mt-8 text-white">
                Instant Alerts & Measures
              </h2>
              <p className="font-inter max-w-md pr-5 text-base text-white">
                When a threat is detected, alerts and preventive measures are triggered immediately to safeguard your system.
              </p>
            </div>
          ...
          <div className="relative my-8 flex w-full rounded-md md:mx-8 md:flex-col">
            ...
            <div className="ml-6 md:ml-0">
              ...
              <p className="font-inter max-w-md pr-5 text-base text-white">
                Take immediate action using easy, one-click security solutions to neutralize threats and protect your data.
              </p>
            </div>
          </div>
        </div>
